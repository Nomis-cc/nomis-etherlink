...
namespace Nomis.PolygonId
{
        ...
        ISingletonService
    {
        ...
        public async Task<Result<DIDData?>> CreateClaimAndGetQrAsync<TWalletStatsRequest, TWalletStats,
            ...
            TWalletStatsRequest request, int mintedScore, TWalletStats walletStats, long expiration, ulong scoredChain, CancellationToken cancellationToken, string? multichainBlockchains = null)
...
#pragma warning restore S6608 // Prefer indexing instead of "Enumerable" methods on types implementing "IList"
                        ...
                        _logger.LogInformation("DID claim created: {Id}", createClaimResponse.Id);
