...
namespace Nomis.PolygonId.Interfaces.PolygonIdIssuerNode
{
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 403)
                        {
                            ...
                            throw new PolygonIdApiException<GenericErrorMessage>("Permission Denied", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 500)
                        {
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 409)
                        {
                            ...
                            throw new PolygonIdApiException<GenericErrorMessage>("Conflict", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 500)
                        {
    ...
    public partial class RefreshService
    {
        ...
        public RefreshServiceType Type { get; set; }

    }

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.18.0.0 (NJsonSchema v10.8.0.0 (Newtonsoft.Json v13.0.3.0))")]
    public partial class DisplayMethod
    {
        [Newtonsoft.Json.JsonProperty("id", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        public string Id { get; set; }
        ...
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public DisplayMethodType Type { get; set; }
    ...
    public partial class CreateClaimRequest
    {
        ...
        [Newtonsoft.Json.JsonProperty("refreshService", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public RefreshService RefreshService { get; set; }

        [Newtonsoft.Json.JsonProperty("displayMethod", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.18.0.0 (NJsonSchema v10.8.0.0 (Newtonsoft.Json v13.0.3.0))")]
    public enum RefreshServiceType
    {

        [System.Runtime.Serialization.EnumMember(Value = @"Iden3RefreshService2023")]
        Iden3RefreshService2023 = 0,

    }

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.18.0.0 (NJsonSchema v10.8.0.0 (Newtonsoft.Json v13.0.3.0))")]
    public enum DisplayMethodType
    {

        [System.Runtime.Serialization.EnumMember(Value = @"Iden3BasicDisplayMethodV1")]
        Iden3BasicDisplayMethodV1 = 0,
